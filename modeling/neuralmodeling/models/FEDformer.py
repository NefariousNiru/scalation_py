...
from modeling.neuralmodeling.layers.AutoCorrelation import (
    AutoCorrelation,
    AutoCorrelationLayer,
)
from modeling.neuralmodeling.layers.FourierCorrelation import (
    FourierBlock,
    FourierCrossAttention,
)
from modeling.neuralmodeling.layers.MultiWaveletCorrelation import (
    MultiWaveletCross,
    MultiWaveletTransform,
)
from modeling.neuralmodeling.layers.Autoformer_EncDec import (
    Encoder,
    Decoder,
    EncoderLayer,
    DecoderLayer,
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        dec_modes = int(
            min(configs["modes"], (configs["seq_len"] // 2 + self.pred_len) // 2)
        )
    ...
    def forward(self, x_enc, x_mark_enc, dec_inp, x_dec, x_mark_dec, use_tf=False):
        # decomp init
